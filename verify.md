...
このライブラリは、主に以下の問題を使用して動作確認やパフォーマンス改善を行っています。  
（思い出し次第追記）
...
- [ABC185 E Sequence Matching](https://atcoder.jp/contests/abc185/tasks/abc185_e)
...
- [PAST16 M 線分の交差判定](https://atcoder.jp/contests/past16-open/tasks/past202309_m)
- [天下一プログラマーコンテスト2014予選A D EMLauncher](https://atcoder.jp/contests/tenka1-2014-quala/tasks/tenka1_2014_qualA_d)
...
- [AtCoder Library Practice Contest A Disjoint Set Union](https://atcoder.jp/contests/practice2/tasks/practice2_a)
